...
st.set_page_config(
    page_title="AmpliCodr – ED Code Classifier",
    page_icon="💡",
    layout="wide",
...
local_css("ampli_styles.css")

# Load and show logo
from PIL import Image
logo = Image.open("amplar_logo.png")
st.image(logo, width=150)

# Title and description
st.markdown("<h1 style='color:#444;font-size:48px;'>AmpliCodr</h1>", unsafe_allow_html=True)

st.markdown("""
<div style='font-size:18px; color:#444;'>

<b>AmpliCodr</b> is a clinical coding exploration tool designed for use in Australian Emergency Departments.<br><br>
...
<b>Note:</b> In practice, ED funding is influenced by additional factors including patient age, triage category, comorbidities, and procedures performed.  
The ED code alone does <b>not</b> determine the total funding.<br><br>

<b>How it works:</b><br>
AmpliCodr uses semantic similarity (via embedding-based search) to identify the most relevant codes from a shortlist of ED diagnoses.  
It then passes those to GPT‑4o for reasoning and ranking based on your case note.<br>
...
Use of AmpliCodr should be reviewed by your institution’s ICT, privacy, and research governance teams before operational use.<br><br>

This tool does <b>not provide medical advice</b> or guaranteed coding accuracy, and is <b>not intended for patient care or documentation</b>.
